//==============================================================================
// Unit........: adLabelDBLookupComboBox.pas
// Created.....: 08/04/2005
...
type
  ...
  //-----| Class: TadLabelDBLookupComboBox

  TadLabelDBLookupComboBox = class(TDBLookupComboBox)
  private
...
// TadLabelDBLookupComboBox ----------------------------------------------------------------

constructor TadLabelDBLookupComboBox.Create(AOwner: TComponent); 
begin
...
destructor TadLabelDBLookupComboBox.Destroy;
begin
  FreeAndNil(FColors);
...
{$IFNDEF LINUX}
procedure TadLabelDBLookupComboBox.CMBidimodechanged(var Message: TMessage);
begin
  inherited;
...
// -----------------------------------------------------------------------------
{$IFDEF LINUX}
procedure TadLabelDBLookupComboBox.Visiblechanged;
{$ELSE}
procedure TadLabelDBLookupComboBox.CMVisiblechanged(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  if Assigned(FLabelDefs) then
...
{$IFDEF LINUX}
procedure TadLabelDBLookupComboBox.EnabledChanged;
{$ELSE}
procedure TadLabelDBLookupComboBox.CMEnabledchanged(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  if Assigned(FLabelDefs) then
...
// -----------------------------------------------------------------------------
{$IFDEF LINUX}
procedure TadLabelDBLookupComboBox.MouseEnter(AControl: TControl);
{$ELSE}
procedure TadLabelDBLookupComboBox.CMMouseEnter(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  DoEnter;
...
{$IFDEF LINUX}
procedure TadLabelDBLookupComboBox.MouseLeave(AControl: TControl);
{$ELSE}
procedure TadLabelDBLookupComboBox.CMMouseLeave(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  DoExit;
...
procedure TadLabelDBLookupComboBox.DoEnter;
begin
  inherited;
...
procedure TadLabelDBLookupComboBox.DoExit;
begin
  inherited;
...
procedure TadLabelDBLookupComboBox.SetColors(const Value : TadColors);
begin
...
procedure TadLabelDBLookupComboBox.Notification(AComponent: TComponent; Operation: TOperation);
begin
...
procedure TadLabelDBLookupComboBox.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TadLabelDBLookupComboBox.SetPosition(const Value: TadControlPosition);
begin
  if Assigned(FLabelDefs) then
...
procedure TadLabelDBLookupComboBox.SetSpacing(const Value: Integer);
begin
  FLabelSpacing := Value;
  SetPosition(FLabelPosition);
end;
...
procedure TadLabelDBLookupComboBox.SetName(const Value: TComponentName);
begin
...
{$IFDEF LINUX}
procedure TadLabelDBLookupComboBox.SetParent(const Value: TWidgetControl);
begin
...
{$ELSE}
procedure TadLabelDBLookupComboBox.SetParent(AParent: TWinControl);
begin
