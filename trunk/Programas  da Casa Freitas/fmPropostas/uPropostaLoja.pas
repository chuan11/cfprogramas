...
begin
   ...
   begin
      ...
      table.FieldByName('NCM_SH').AsString := ds.fieldByName('preco').AsString;
   end;
   ds.Free();
end;
...
begin
   ...
   begin
      ...
      cmd := 'Create Table '+ nmTable +'( Codigo varchar(13), Descricao varchar(50), Quant int, Und money, Total money, NCM_SH varchar(10) ) ';
