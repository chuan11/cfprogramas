object frmNovoPagamento: TfrmNovoPagamento
  Left = 283
  Top = 246
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Novo pagamento de mensalidade'
  ClientHeight = 125
  ClientWidth = 481
  Color = clBtnFace
  ...
  object dtpVenc: TDateTimePicker
    ...
    Width = 89
    Height = 21
    Date = 36944.000000000000000000
    Time = 36944.000000000000000000
    Enabled = False
    TabOrder = 6
  end
  ...
  object dtpPagto: TDateTimePicker
    ...
    Width = 105
    Height = 21
    Date = 39902.435554062500000000
    Time = 39902.435554062500000000
    TabOrder = 7
  end
  object qryPagtos: TQuery
    CachedUpdates = True
    DatabaseName = 'Banco de Dados Academia'
    DataSource = frmPagamento.dsAlunos
    SQL.Strings = (
      'SELECT *'
      'FROM'
      ' PAGAMENTO'
  ...
  object qryVenc: TQuery
    ...
    Left = 336
    Top = 96
    object qryVencDATA_VENC: TDateTimeField
      FieldName = 'DATA_VENC'
      Origin = 'BANCO DE DADOS ACADEMIA.Aluno.DATA_VENC'
    end
    object qryVencCOD_ALU: TIntegerField
      FieldName = 'COD_ALU'
      Origin = 'BANCO DE DADOS ACADEMIA.Aluno.COD_ALU'
    end
    object qryVencVLR_DEVIDO: TFloatField
  ...
  object qryCodigo: TQuery
    DatabaseName = 'Banco de Dados Academia'
    SQL.Strings = (
      'SELECT MAX(COD_PAG)+1 FROM PAGAMENTO')
    Left = 328
    Top = 64
    object qryCodigoCOLUMN1: TIntegerField
      FieldName = 'COLUMN1'
      Origin = 'BANCO DE DADOS ACADEMIA.Pagamento.COD_PAG'
    end
  end
