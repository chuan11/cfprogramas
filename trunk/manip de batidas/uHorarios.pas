...
begin
   ...
   ds := funcsql.getDataSetQ('Select * from zcf_pontoHorarios where num  = ' + tbHor.fieldByName('num').AsString, Form2.conexaoWell);
...
begin
   if ( funcSQl.openSQL('Select top 01 horario_num from zcf_pontoEmpregados where horario_num = ' +  tbHor.fieldByname('num').asString, 'horario_num', Form2.conexaoWell ) <> '' ) then
   begin
