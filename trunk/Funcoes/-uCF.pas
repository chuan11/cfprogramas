...
interface
   uses ADODB, Classes, sysutils, Dialogs, forms, DBGrids,
        ...
        IdBaseComponent, IdComponent, IdRawBase, IdRawClient, IdIcmpClient, IdTelnet,
        {uses }funcsql, uMain, uListaFornecedores, funcDatas, funcoes, {uSelecionaUo, } SoftDBGrid ;
...
var
   cmd:String;
   ds:TdataSet;
//   modalidades:Tstringlist;
begin
   if (tb.TableName <> '') then
      tb.Close();

   ds := getPreviaGeralCaixa( uo, caixa, dt.date, dt.date, false, listaSoCartao);
