...
type
   ...
   //-----| Class: TadLabelDBListBox

  TadLabelDBListBox = class(TDBImage)
  private
...
constructor TadLabelDBListBox.Create(AOwner: TComponent); 
begin
...
destructor TadLabelDBListBox.Destroy;
begin
  FreeAndNil(FColors);
...
{$IFNDEF LINUX}
procedure TadLabelDBListBox.CMBidimodechanged(var Message: TMessage);
begin
  inherited;
...
// -----------------------------------------------------------------------------
{$IFDEF LINUX}
procedure TadLabelDBListBox.Visiblechanged;
{$ELSE}
procedure TadLabelDBListBox.CMVisiblechanged(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  if Assigned(FLabelDefs) then
...
{$IFDEF LINUX}
procedure TadLabelDBListBox.EnabledChanged;
{$ELSE}
procedure TadLabelDBListBox.CMEnabledchanged(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  if Assigned(FLabelDefs) then
...
// -----------------------------------------------------------------------------
{$IFDEF LINUX}
procedure TadLabelDBListBox.MouseEnter(AControl: TControl);
{$ELSE}
procedure TadLabelDBListBox.CMMouseEnter(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  DoEnter;
...
{$IFDEF LINUX}
procedure TadLabelDBListBox.MouseLeave(AControl: TControl);
{$ELSE}
procedure TadLabelDBListBox.CMMouseLeave(var Message: TMessage);
{$ENDIF}
begin
  inherited;
  DoExit;
...
procedure TadLabelDBListBox.DoEnter;
begin
  inherited;
...
procedure TadLabelDBListBox.DoExit;
begin
  inherited;
...
procedure TadLabelDBListBox.SetColors(const Value : TadColors);
begin
...
procedure TadLabelDBListBox.Notification(AComponent: TComponent; Operation: TOperation);
begin
...
procedure TadLabelDBListBox.SetBounds(ALeft, ATop, AWidth, AHeight: Integer);
begin
...
procedure TadLabelDBListBox.SetPosition(const Value: TadControlPosition);
begin
  if Assigned(FLabelDefs) then
...
procedure TadLabelDBListBox.SetSpacing(const Value: Integer);
begin
  FLabelSpacing := Value;
  SetPosition(FLabelPosition);
end;
...
procedure TadLabelDBListBox.SetName(const Value: TComponentName);
begin
...
{$IFDEF LINUX}
procedure TadLabelDBListBox.SetParent(const Value: TWidgetControl);
begin
...
{$ELSE}
procedure TadLabelDBListBox.SetParent(AParent: TWinControl);
begin
