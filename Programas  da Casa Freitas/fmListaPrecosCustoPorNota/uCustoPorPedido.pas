...
uses
  ...
  fCtrls, adLabelEdit, funcoes, funcsql, funcDatas;
...
begin //
   ...
   begin
      ...
      uCF.getCRUCBaseNota(fmMain.Conexao, qr, tb.fieldByname('is_ref').asString);
...
begin
  ...
  fmMain.impressaoRave(tb,'rpCRUCNPorPedido', param );
end;
