...
uses
  ...
  Dialogs, StdCtrls, Buttons, ComCtrls, fCtrls, funcDatas, uUtil;
...
uses RelogioPonto, uConsultarBatidas;
...
begin
   ListBox.Items.Clear;
   ListBox.Items.Add('Batidas do dia: ' + dateToStr(dti.date) +'  '+funcDatas.getDescricaoDia(dti.Date,true));
   ListBox.Items.Add('------------------------------');
   screen.Cursor := crHourGlass;
   bat := TStringList.Create;
   bat :=  uUtil.getBatidas( dateToStr(dti.Date), dateToStr(dti.Date), label1.Caption );
